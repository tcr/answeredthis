...
Object.defineProperty(exports, "__esModule", { value: true });
// Global CSS
__webpack_require__(/*! ../styles/theme.scss */ "./styles/theme.scss");
            ...
            React.createElement("div", { id: "header" },
                ...
                self.state.logged_in ?
                    React.createElement("div", { className: "caption" },
                        React.createElement("a", { href: "/new" }, "Submit new answer?"))
                    : null),
            this.state.answers.map((item, i) => {
                return (React.createElement("div", { className: `answer ${item.answered ? 'answered' : 'collapsed'}`, key: item.id },
                    React.createElement("div", { className: "title", dangerouslySetInnerHTML: { __html: item.title }, style: {
                            cursor: 'pointer',
                        }, onClick: (e) => {
                    ...
                    React.createElement("div", { className: "as-of" },
                        React.createElement("a", { href: `/edit?id=${item.id}` },
                            "As of ",
                            item.asof,
                            ".")),
                    React.createElement("div", { className: "content", dangerouslySetInnerHTML: { __html: item.content } })));
            }),
...
function start() {
    ...
    axios_1.default.get('/api/answers/')
        .then((res) => {
        ReactDOM.render(React.createElement(Answers, { answers: res.data.answers, logged_in: res.data.logged_in }), document.querySelector('#content'));
    })
        .catch((err) => {
        console.log(err);
    });
...
/******/ });
//# sourceMappingURL=answeredthis.js.map